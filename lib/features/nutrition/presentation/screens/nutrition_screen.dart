...
class _NutritionScreenState extends ConsumerState<NutritionScreen> {
          ...
          child: Column(
            ...
            children: [
              ...
              ...['breakfast', 'lunch', 'dinner', 'snack']
                  .map((meal) => _buildMealSection(context, meal, summary, loc)),
  ...
  Widget _buildCaloriesCard(
    ...
    final pct = (_targetCals > 0 ? summary.totalCalories / _targetCals : 0)
        .clamp(0.0, 1.0)
        .toDouble();
    final remaining =
        (_targetCals - summary.totalCalories).clamp(0.0, double.infinity).toDouble();
  ...
  Widget _macroCard(
    ...
    final pct = (target > 0 ? current / target : 0).clamp(0.0, 1.0).toDouble();
    ...
    return Column(
      ...
      children: [
        Row(
          children: [
            Icon(
              mealIcons[mealType] ?? Icons.food_bank_outlined,
              size: 18,
            ...
            IconButton(
              ...
              onPressed: () => _showAddFood(context, preselectedMeal: mealType),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '${entry.amount.toStringAsFixed(0)}g',
                    style: const TextStyle(
                      fontFamily: 'Cairo',
                      fontSize: 11,
                      color: AppColors.textGrey,
